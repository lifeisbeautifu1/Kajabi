const Stats = () => {
  return (
    <div className="bg-blue-600 text-white flex flex-col gap-10 items-center text-6xl font-semibold py-12">
      <h1>
        Creators use Kajabi <br />{' '}
        <span className="text-gray-800">to do and earn more</span>
      </h1>
      <div className="flex gap-4 items-center">
        <div className="flex flex-col items-center gap-4 px-10 border-r-2 border-white">
          <h1>$3.9 B+</h1>
